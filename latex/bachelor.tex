...
\begin{itemize}
	...
	\subitem Tracking precision and quality of generated hand poses
	\subitem User performance when interacting with the interface
...
\begin{itemize}
	...
	\subitem Controller-based interaction, e.g. via some controller-tailored abstract interface, or pointing and grabbing of the natural interface
	\subitem Full hand tracking via Leap Motion sensor
